...
from .views.nuptial import search_nuptial_males, found_colony, get_my_specie_builder
...
urlpatterns = [
    ...
    path('world/nuptial_environment/specie_builder', get_my_specie_builder, name='get_my_specie_builder'),
