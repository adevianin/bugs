...
class WorldDeserializer():
    ...
    def __init__(self, world_factory: WorldFactory, nest_deserializer: NestDeserializer, ant_deserializer: AntDeserializer, colony_deserializer: ColonyDeserializer, 
                 ...
                 nuptial_environment_deserializer: NuptialEnvironmentDeserializer, climate_deserializer: ClimateDeserializer):
    ...
    def deserialize(self, world_json: dict) -> World:
        ...
        world = self._world_factory.build_world(last_used_id, entities_collection, map, colonies, colony_relations_table, nuptial_environments, climate, current_step)
