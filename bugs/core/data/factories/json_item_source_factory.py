...
class JsonItemSourceFactory():
    ...
    def build_item_source_from_json(self, item_source_factory_json: dict):
        ...
        angle = item_source_factory_json['angle']
        ...
        return self._item_source_factory.build_item_source(id, from_colony_id, hp, position, angle, item_type, fertility, accumulated, min_item_strength, max_item_strength)