...
class JsonNestFactory():
    ...
    def build_nest_from_json(self, nest_json: dict):
        ...
        return self._nest_factory.build_nest(nest_json['id'], position, nest_json['from_colony'], larvae, nest_json['larva_places_count'], nest_json['stored_calories'], nest_json['area'])
