...
class JsonColonyFactory():
    ...
    def build_colony_from_json(self, colony_json, entities_collection: EntityCollection, map: Map):
        operations = []
        ...
        return self._colony_factory.build_colony(colony_json['id'], colony_json['owner_id'], map, operations)