...
class ThoughtFactory:
    ...
    def build_reinforce_nest_defence_thought(self, body: LiveBody, fight_near_enemies_thought: FightNearEnemiesThought, random_walk_thought: RandomWalkThought, defending_nest: Nest, point_to_check: Point, flags: dict = None, sayback: str = None):
    ...
    def build_reinforce_nest_defence_thought_full(self, body: LiveBody, nest: Nest, point_to_check: Point, sayback: str = None):
        random_walk_thought = self.build_random_walk_thought(body, nest.position, nest.area)
        fight_near_enemies_thought = self.build_fight_near_enemies_thought_full(body=body)
