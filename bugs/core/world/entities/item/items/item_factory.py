...
class ItemFactory():
    ...
    def build_item(self, id: int, item_type: ItemTypes, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, hp: int) -> Item:
        match (item_type):
    ...
    def _build_flower_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, hp: int):
    ...
    def _build_leaf_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, hp: int):
        stats = StatsLibrary.GHOST_DEFAULT
    ...
    def _build_honeydew_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, hp: int):
        stats = StatsLibrary.GHOST_DEFAULT
    ...
    def _build_ground_beetle_corpse_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, hp: int):
        stats = StatsLibrary.GHOST_DEFAULT
