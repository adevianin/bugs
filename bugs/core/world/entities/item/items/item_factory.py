...
class ItemFactory():
    ...
    def build_item(self, id: int, item_type: ItemTypes, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, 
                   ownership: OwnershipConfig, is_removal_blocked: bool, hp: int) -> Item:
        match (item_type):
            case ItemTypes.FLOWER:
                return self._build_flower_item(id, position, angle, strength, variety, life_span, is_picked, ownership, is_removal_blocked, hp)
            case ItemTypes.LEAF:
                return self._build_leaf_item(id, position, angle, strength, variety, life_span, is_picked, ownership, is_removal_blocked, hp)
            case ItemTypes.HONEYDEW:
                return self._build_honeydew_item(id, position, angle, strength, variety, life_span, is_picked, ownership, is_removal_blocked, hp)
            case ItemTypes.GROUND_BEETLE_CORPSE:
                return self._build_ground_beetle_corpse_item(id, position, angle, strength, variety, life_span, is_picked, ownership, is_removal_blocked, hp)
            case ItemTypes.ANT_FOOD:
                return self._build_ant_food_item(id, position, angle, strength, variety, life_span, is_picked, ownership, is_removal_blocked, hp)
            case ItemTypes.STICK:
                return self._build_stick_item(id, position, angle, strength, variety, life_span, is_picked, ownership, is_removal_blocked, hp)
            case _:
    ...
    def _build_flower_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig,
                           is_removal_blocked: bool, hp: int):
        ...
        return FlowerItem(self._event_bus, EventEmitter(), id, body, ownership, is_removal_blocked, strength, variety, life_span, is_picked)
    ...
    def _build_leaf_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, 
        ...
        return LeafItem(self._event_bus, EventEmitter(), id, body, ownership, is_removal_blocked, strength, variety, life_span, is_picked)
    ...
    def _build_honeydew_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, 
        ...
        return HoneydewItem(self._event_bus, EventEmitter(), id, body, ownership, is_removal_blocked, strength, variety, life_span, is_picked)
    ...
    def _build_ground_beetle_corpse_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig,
        ...
        return GroundBeetleCorpseItem(self._event_bus, EventEmitter(), id, body, ownership, is_removal_blocked, strength, variety, life_span, is_picked)
    
    def _build_ant_food_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig, 
                             is_removal_blocked: bool, hp: int):
        stats = StatsLibrary.GHOST_DEFAULT
        ...
        return AntFoodItem(self._event_bus, EventEmitter(), id, body, ownership, is_removal_blocked, strength, variety, life_span, is_picked)
    
    def _build_stick_item(self, id: int, position: Point, angle: int, strength: int, variety: int, life_span: int, is_picked: bool, ownership: OwnershipConfig,
                          is_removal_blocked: bool, hp: int):
        stats = StatsLibrary.GHOST_DEFAULT
        ...
        return StickItem(self._event_bus, EventEmitter(), id, body, ownership, is_removal_blocked, strength, variety, life_span, is_picked)
