...
class HoneydewItemSource(ItemSource):
    ...
    def __init__(self, event_bus: EventEmitter, events: EventEmitter, id: int, ownership: OwnershipConfig, body: HoneydewItemSourceBody, fertility: int, accumulated: int, min_item_strength: int, max_item_strength: int):
