...
class AntBirther(EntityBirther):
    ...
    def __init__(self, event_bus: EventEmitter, map: Map, ant_factory: AntFactory):
        super().__init__(event_bus, 'ant_birth_request', map)
    ...
    def _handle_ant_from_system_request(self, request: AntBirthFromSystemRequest):
        ...
        return self._ant_factory.build_new_ant(larva.name, ownership, larva.genome, larva.ant_type, request.position, self._current_step, None)
    ...
    def _handle_ant_from_nest_request(self,request: AntBirthFromNestRequest):
        ...
        return self._ant_factory.build_new_ant(larva.name, ownership, larva.genome, larva.ant_type, nest.position, self._current_step, nest)
