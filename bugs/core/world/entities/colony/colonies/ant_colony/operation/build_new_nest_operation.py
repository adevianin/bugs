...
class BuildNewNestOperation(Operation):
    ...
    def __init__(self, events: EventEmitter, formation_manager: FormationManager, id: int, hired_ants: List[Ant], flags: dict, building_site: Point):
        super().__init__(events, formation_manager, id, OperationTypes.BUILD_NEW_NEST, hired_ants, flags)
