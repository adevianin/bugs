...
class OperationFactory():
    ...
    def build_transport_food_operation(self, nest_from: Nest, nest_to: Nest, food_count: int, transported_food_count: int, workers_count: int, id: int = None, hired_ants: List[Ant] = None, flags: dict = None, formations: List[BaseFormation] = []):
        return TransportFoodOperation(EventEmitter(), self._formation_factory, id, hired_ants, flags, formations, nest_from, nest_to, food_count, transported_food_count, workers_count)