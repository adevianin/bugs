...
class AntFactory():
    ...
    def build_new_worker_ant(self, id: int, from_colony_id: int, owner_id: int, genome: Genome, position: Point, home_nest: Nest):
        return self.build_worker_ant(id, from_colony_id, owner_id, position, 0, None, home_nest, None, None, True, None, False, genome, GuardianBehaviors.NEST, True)
    
    def build_new_warrior_ant(self, id: int, from_colony_id: int, owner_id: int, genome: Genome, position: Point, home_nest: Nest):
        return self.build_warrior_ant(id, from_colony_id, owner_id, position, 0, None, home_nest, None, None, True, None, False, genome, GuardianBehaviors.COLONY, True)
    
    def build_new_queen_ant(self, id: int, from_colony_id: int, owner_id: int, genome: Genome, position: Point, home_nest: Nest):
        return self.build_queen_ant(id, from_colony_id, owner_id, position, 0, None, home_nest, None, None, True, None, False, genome, None, False, GuardianBehaviors.NONE, False)
    
    def build_new_male_ant(self, id: int, from_colony_id: int, owner_id: int, genome: Genome, position: Point, home_nest: Nest):
        return self.build_male_ant(id, from_colony_id, owner_id, position, 0, None, home_nest, None, None, True, None, False, genome, GuardianBehaviors.NONE, False)
