...
class AntFactory():
    ...
    def build_ant(self, id: int, from_colony: int, ant_type: AntTypes, dna_profile: str, position: Point, hp: int, home_nest: Nest, located_in_nest: Nest, memory_data: dict, picked_food: Food, is_auto_thought_generation: bool, is_in_operation: bool) -> Ant:
        match ant_type:
            case AntTypes.WORKER:
                return self._build_worker_ant(id, from_colony, dna_profile, position, hp, home_nest, located_in_nest, memory_data, is_auto_thought_generation, picked_food, is_in_operation)
            case AntTypes.WARRIOR:
                return self._build_warrior_ant(id, from_colony, dna_profile, position, hp, home_nest, located_in_nest, memory_data, is_auto_thought_generation, picked_food, is_in_operation)
            case AntTypes.QUEEN:
                return self._build_queen_ant(id, from_colony, dna_profile, position, hp, home_nest, located_in_nest, memory_data, is_auto_thought_generation, picked_food, is_in_operation)
            case _:
                raise Exception('uknown type of ant')
            
    def _build_warrior_ant(self, id: int, from_colony: int, dna_profile: str, position: Point, hp: int, nest: Nest, located_in_nest: Nest, memory_data: dict, is_auto_thought_generation: bool, picked_food: Food, is_in_operation: bool):
        events = EventEmitter()
        sayer = EventEmitter()
    ...
    def _build_worker_ant(self, id: int, from_colony: int, dna_profile: str, position: Point, hp: int, nest: Nest, located_in_nest: Nest, memory_data: dict, is_auto_thought_generation: bool, picked_food: Food, is_in_operation: bool):
        events = EventEmitter()
        sayer = EventEmitter()
        world_interactor = WorldInteractor()
        memory = Memory(memory_data)
    ...
    def _build_queen_ant(self, id: int, from_colony: int, dna_profile: str, position: Point, hp: int, nest: Nest, located_in_nest: Nest, memory_data: dict, is_auto_thought_generation: bool, picked_food: Food, is_in_operation: bool):
        events = EventEmitter()
        sayer = EventEmitter()
        world_interactor = WorldInteractor()
        memory = Memory(memory_data)
