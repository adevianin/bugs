...
class AntFactory():
    ...
    def build_new_ant(self, id: int, from_colony_id: int, ant_type: AntTypes, dna_profile: str, position: Point, home_nest: Nest):
        return self.build_ant(id, from_colony_id, ant_type, dna_profile, position, None, home_nest, None, None, None, True, False)

    def build_ant(self, id: int, from_colony: int, ant_type: AntTypes, dna_profile: str, position: Point, hp: int, home_nest: Nest, located_in_nest: Nest, memory: Memory, picked_food: Food, is_auto_thought_generation: bool, is_in_operation: bool) -> Ant:
        match ant_type:
            case AntTypes.WORKER:
                return self._build_worker_ant(id, from_colony, dna_profile, position, hp, home_nest, located_in_nest, memory, is_auto_thought_generation, picked_food, is_in_operation)
            case AntTypes.WARRIOR:
                return self._build_warrior_ant(id, from_colony, dna_profile, position, hp, home_nest, located_in_nest, memory, is_auto_thought_generation, picked_food, is_in_operation)
            case AntTypes.QUEEN:
                return self._build_queen_ant(id, from_colony, dna_profile, position, hp, home_nest, located_in_nest, memory, is_auto_thought_generation, picked_food, is_in_operation)
            case _:
