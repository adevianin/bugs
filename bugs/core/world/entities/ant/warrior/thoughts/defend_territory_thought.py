...
class DefendTerritoryThought(Thought):
    ...
    def __init__(self, fight_enemy_thought: FightEnemyThought, search_walk_thought: SearchingWalkThought, defending_nest: Nest, point_to_check: Point = None, reinforcing_nest: Nest = None, point_to_reinforce: Point = None, flags: dict = None, sayback: str = None):
