...
class DefendColonyThought(Thought):
    ...
    def __init__(self, body: AntBody, fight_near_enemies_thought: FightNearEnemiesThought, point_to_check: Point = None, flags: dict = None, sayback: str = None):
        super().__init__(body=body, type=ThoughtTypes.DEFEND_COLONY, flags=flags, sayback=sayback)
