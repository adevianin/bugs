...
class NuptialEnvironmentFactory():
    ...
    def build_nuptial_environment(self, owner_id: int, specie: Specie, attack_weight: int = 0, 
        ...
        return NuptialEnvironment(self._event_bus, owner_id, specie, specie_activity)