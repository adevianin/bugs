...
class StatsLibrary():
    ...
    GROUND_BEETLE_DEFAULT = LiveStats.build(max_hp=800, hp_regen_rate=10, distance_per_step=32, sight_distance=200, attack=20, defence=5, appetite=0, min_temperature=-10, life_span=1000000)
