...
class StatsLibrary():
    ...
    LADYBUG_DEFAULT = LiveStats.build(max_hp=300, hp_regen_rate=5, distance_per_step=32, sight_distance=200, strength=10, defence=6, appetite=0, min_temperature=-1, life_span=1 * STEPS_IN_YEAR)
