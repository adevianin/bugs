...
class StatsLibrary():
    ...
    LADYBUG_DEFAULT = LiveStats.build(max_hp=300, hp_regen_rate=5, distance_per_step=32, sight_distance=300, strength=20, defence=5, appetite=0, min_temperature=-1, life_span=1000000)
