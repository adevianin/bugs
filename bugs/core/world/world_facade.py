...
class WorldFacade:
    ...
    def build_new_sub_nest_operation(self, user_id: int, performing_colony_id: int, building_site: List[int], workers_count: int):
    ...
    def add_larva(self, user_id: int, nest_id: int, larva_type: str):
