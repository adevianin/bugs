...
const UK_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_SPECIE]: `
        ...
        <p>
            Щоб передавати нові гени у свій вид, відправляй самців у шлюбний літ. Вони знайдуть далеку самку твого виду та запліднять її. У результаті, гени самця з'являться у списку кандидатних. Вибирай самців з найкращими генами, відправляй їх у літ — і поступово закріплюй хороші гени у своєму виді.
        </p>
