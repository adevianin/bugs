...
const UK_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_START]: `
        ...
        <p>
            Щоб започаткувати колонію, дочекайся теплого сезону. Коли температура дозволяє, відкрий вкладку "Розмноження" <span data-breeding-tab-icon-container></span>. Там ти зможеш:
        </p>
        <ul>
        ...
        <p>
            Переконайся, що джерело їжі потрапляє в область гнізда — вона обведена жовтою лінією. Лише тоді робочі мурахи зможуть знаходити й використовувати ці ресурси. Рідкі ресурси (нектар, медяна роса) мурахи переносять у спеціальному мішечку всередині черевця — коли він наповнений, черевце помітно роздувається. Тверді предмети мурахи переносять у щелепах.
        </p>
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_BREEDING]: `
        ...
        <p>
            Коли самка запліднюється, вона отримує набір хромосом від самця. Цей набір зберігається і використовується для відкладання майбутніх яєць. А самець після запліднення помирає, його місія виконана.
        </p>
        <p>
            Відкладаючи яйце, самка передає йому набір хромосом. Оскільки самка диплоїдна(має два набори хромосом, успадковані від батьків), в яйце потрапляє лише один набір — він формується в процесі мейозу. Мейоз — це тип клітинного поділу, під час якого з диплоїдної клітини утворюється гаплоїдна, тобто така, що містить один набір хромосом. Таким чином, яйце отримує випадковий набір хромосом самки. Крім того, яйце може також отримати набір хромосом від самця, який запліднив самку. Наявність або відсутність цього набору визначає, якого типу буде яйце.
        </p>
        <p>
            Є два типи яєць:
        </p>
