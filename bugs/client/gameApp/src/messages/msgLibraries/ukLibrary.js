...
const UK_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.BREEDING_LABEL_NEW_COLONY_NAME]: 'Назва гнізда:',
    ...
    [GAME_MESSAGE_IDS.GENE_LABEL_ADAPTATION_DEVELOPMENT_APPETITE_DESCRIPTION]: 'визначає потребу в їжі для розвитку мурахи',
    ...
    [GAME_MESSAGE_IDS.COLONIES_TAB_LABEL_COLONY_SELECTOR]: 'Королева:',
    [GAME_MESSAGE_IDS.COLONIES_TAB_SHOW_COLONY_BTN]: 'показати',
    ...
    [GAME_MESSAGE_IDS.ANTS_LIST_COL_NAME_TYPE]: 'каста',
    ...
    [GAME_MESSAGE_IDS.ANT_SHOW_BTN_LABEL]: 'показати',
    ...
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_DESTROY_NEST_BTN_LABEL]: 'зруйнувати гніздо',
    ...
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_BUILD_FORTIFICATIONS_BTN_LABEL]: 'будувати укріплення гнізда',
    ...
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_OPER_CATEGORY_TITLE_BUILDING]: 'будівництво',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_OPER_CATEGORY_TITLE_OFFENSIVE]: 'наступальні',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_OPER_CATEGORY_TITLE_RESOURCE]: 'ресурсні',
    ...
    [GAME_MESSAGE_IDS.OPERATION_ACTIVATE_BTN_LABEL]: 'показати',
    ...
    [GAME_MESSAGE_IDS.NESTS_TAB_SHOW_NEST_BTN]: 'показати',
    ...
    [GAME_MESSAGE_IDS.NEST_MANAGER_MAIN_TAB_NEEDED_FOOD_COUNT_LABEL]: 'зимовий запас їжі:',
    [GAME_MESSAGE_IDS.NEST_MANAGER_MAIN_TAB_NEST_POPULATION_LABEL]: 'населення гнізда:',
    ...
    [GAME_MESSAGE_IDS.NEST_MANAGER_LARVA_TAB_DIED_LABEL]: 'загинув',
    ...
    [GAME_MESSAGE_IDS.ENEMIES_TAB_SHOW_ENEMY_BTN_LABEL]: 'показати',
    [GAME_MESSAGE_IDS.ENEMIES_TAB_TABLE_COL_COLONY_NAME]: 'ім\'я ворожої королеви',
    ...
    [GAME_MESSAGE_IDS.NOTIFICATION_OBJECT_COLONY]: 'Колонія королеви',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_COMBAT]: 'загинула у бою',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_FREEZED]: 'померла від холоду',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_AGED]: 'померла від старості',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_HUNGER]: 'померла з голоду',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_WITHOUT_HOME]: 'померла без дому',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_NUPTIAL_FLIGHT]: 'залишила нащадків і померла у льоті',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_UNKNOWN]: 'померла з невідомих причин',
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_BURIED_IN_NEST]: 'загинула в зруйнованому гнізді',
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_WORLD]: `
        ...
        <ul>
            <li>
                <b>Весна</b> — пора пробудження. Природа оживає, але повітря ще прохолодне. Лише холодостійкі мурахи здатні вийти зі сплячки. Інші ще чекають тепла в гніздах. Весною їжі майже немає — залишилися лише запаси, зібрані ще минулого літа. Це складний період для колонії.
            </li>
            <li>
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_START]: `
        <p>
            Новий вид виникає внаслідок одного запліднення — для його виживання та розвитку необхідне створення першої колонії. Щоб її заснувати, зачекай теплої літньої погоди та відкрий вкладку "Розмноження" <span data-breeding-tab-icon-container></span>. Там можна:
        </p>
        <ul>
        ...
        <p>
            <b>Antara</b> — мураха з рідкісною мутацією, яка порушує сталість виду. Її поява — випадковий, але доленосний злам у генетичному ланцюгу. Саме з неї починається нова еволюційна лінія: вона — праматір майбутнього виду, здатного пристосовуватись, боротись і виживати в мінливому світі.
        </p>
        <p>
            <b>Вибір самця</b> для запліднення має вирішальне значення, оскільки генетичний матеріал самця визначає спадковість усієї майбутньої колонії. Після спарювання самець гине, а його хромосоми назавжди залишаються в організмі самки, формуючи генетичну основу тисяч і мільйонів нащадків.
        </p>
        <p>
            Щоб уникнути близькоспорідненого схрещування, самки мурах не спаровуються із самцями зі своєї колонії. Їхній генетичний матеріал надто схожий, що може призвести до слабкого потомства. Тому під час шлюбного льоту самки шукають самців з інших, генетично віддалених колоній.
        </p>
        <p>
            Поведінка всіх колоній виду — і своїх, і далеких — впливає на те, які самці трапляються в шлюбному льоті. Якщо вид часто воює — з’являються бойові самці. Якщо будує гнізда — з будівельними генами. Якщо регулярно страждає від холоду — зростає шанс на холодостійких самців.
        </p>
        <p>
        ...
        <p>
            Джерела їжі мають числовий показник, чим більше значення тим більше там їжі. Переконайся, що джерело їжі потрапляє в область гнізда — вона обведена жовтою лінією. Лише тоді робочі мурахи зможуть знаходити й використовувати ці ресурси.
        </p>
        <p>
        ...
        <p> 
            Як тільки гніздо збудоване, це час для відкладання яєць. Зробити це можна в меню керування гніздом, яке відкриється по кліку на гніздо. Чим більше їжі поряд з гніздом тим більше можна робити мурах.
        <p/>
    `,
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_COLONIES]: `
        <p>
            Мурахи — соціальні істоти. Вони живуть великими спільнотами — колоніями, де кожна особина має своє призначення. Серце колонії — королева. Вона відкладає яйця і підтримує стабільність. Якщо вона помирає — це трагедія. Без неї колонія швидко занепадає. Тому королева найдовговічніша з усіх каст. Керування колоніями мурах відбувається у вкладці "Колонії" <span data-colonies-tab-icon-container></span>.
        </p>
    `,
    [GAME_MESSAGE_IDS.HELP_TAB_SUBSECTION_CONTENT_COLONIES_ANTS]: `
        <p>Кожна мураха в колонії виконує свою роль:</p>
        <ul>
        ...
        <p>
            У колонії є список мурах. В ньому можна відкрити кожну мураху окремо і побачити її характеристики, вік, гени, чим занята або зробити певні дії, наприклад налаштувать поведінку, відправити в шлюбний літ. 
        </p>
    `,
    [GAME_MESSAGE_IDS.HELP_TAB_SUBSECTION_CONTENT_COLONIES_OPERATIONS]: `
        <p>
            Мурахи не розмовляють словами, але чудово розуміють одне одного через феромони — хімічні сигнали, що керують поведінкою колонії. Один запах — і вся група діє.
        </p>
        <p>
            Наприклад, біля гнізда з'явився великий поживний жук. Якась із мурашок його знаходить і виділяє позивний феромон. Інші, відчувши його, біжать, щоб разом затягнути жука до гнізда.
        </p>
        <p>
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SUBSECTION_CONTENT_COLONIES_NESTS]: `
        ...
        <ul>
            <li>дати ім'я майбутній мурахі,</li>
            <li>вибрати режим догляду, що вплине на касту мурахи,</li>
            <li>спостерігати за його дозріванням.</li>
        </ul>
        <p>
            Коли яйце розвинулось, його переносять у камеру личинок, де кормлять аж поки з нього не вилупиться мураха.
        </p>
    `,
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_SPECIE]: `
        ...
        <p>
            Коли королева відкладає яйця, вона передає їм частину свого генетичного матеріалу. Оскільки вона має два набори хромосом (диплоїдна) — один від своєї матері, інший від батька — в кожне яйце потрапляє лише один набір. 
            Це відбувається під час <b>мейозу</b> — процесу, під час якого для кожної пари хромосом випадковим чином обирається одна з двох копій: або материнська, або батьківська. Таким чином, кожне яйце отримує унікальну комбінацію хромосом.
        </p>
        <p>
            Якщо яйце також отримує набір хромосом від самця, воно стає заплідненим. Тип яйця залежить від того, чи відбулося запліднення.
        </p>
        <p>
            Є два типи яєць:
        </p>
        <ul>
            <li>
                <b>Запліднені яйця</b> — мають два набори хромосом: один від матері(після мейозу), один від батька. З таких яєць можуть народитись робочі, воїни або самки.
            </li>
            <li>
                <b>Незапліднені яйця</b> — містять лише материнські хромосоми(після мейозу). З них народжуються тільки самці.
            </li>
        </ul>
        <p>
            У вкладці "Вид" <span data-specie-tab-icon-container></span> відбувається зміна генетичного складу твого виду мурах. Тут гени поділяються на закріплені та кандидатні.
        </p>
        <ul>
        ...
        <p>
            Щоб передавати нові гени у свій вид, відправляй самців у шлюбний літ. Вони знайдуть далеку самку твого виду та запліднять її. У результаті, деякі гени самця передадуться виду і з'являться у списку кандидатних генів. Вибирай самців з найкращими генами, відправляй їх у літ — і поступово закріплюй хороші гени у своєму виді.
        </p>
        ...
        <ul>
            ...
            <li>
                <b>Хромосома Касти</b> — визначає, ким саме стане мураха: робочою, воїном чи самкою. Вона впливає на розвиток особини, підсилюючи або послаблюючи певні риси. Значення генів цієї хромосоми множаться на відповідні гени з хромосоми тіла. Наприклад: якщо сила в хромосомі тіла дорівнює 15, а сила в хромосомі касти — 2, то в результаті сила мурахи буде 15 × 2 = 30.
            </li>
            <li>
        ...
        <p>
            ...
            Гени одного типу з різних наборів хромосом(материнський, батьківський) конкурують між собою. Проявиться той, що є більш <b>домінантним</b>. Порядок кодів домінантності генів (від найсильнішого до найслабшого): <b>A &gt; B &gt; C &gt; D &gt; E</b>.
        </p>
        <p>
