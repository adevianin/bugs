...
const UK_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SUBSECTION_CONTENT_COLONIES_ANTS]: `
        ...
        <p>
            У колонії є список мурах. В ньому можна відкрити кожну мураху окремо і побачити характеристики, гени, чим занятий і зробити певні дії, наприклад відправити мураху в шлюбний літ.
        </p>
    `,
