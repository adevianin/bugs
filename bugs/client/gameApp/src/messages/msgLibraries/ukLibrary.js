...
const UK_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SUBSECTION_CONTENT_COLONIES_NESTS]: `
        ...
        <p>
            У гнізді королева відкладає яйця, передаючи їм частину свого генетичного матеріалу. Оскільки вона має два набори хромосом (диплоїдна), в кожне яйце потрапляє лише один набір — він утворюється під час мейозу. Якщо яйце також отримує набір хромосом від самця, воно стає заплідненим. Тип яйця залежить від того, чи відбулося запліднення.
        </p>
        <p>
            Є два типи яєць:
        </p>
