...
const UK_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_BREEDING]: `
        ...
        <p>
            У самки вже є два набори хромосом (успадковані від її батьків). Під час відкладання яйця гени її хромосом перетасовуються, цей процес називається мейоз. У результаті кожне яйце отримує два набори хромосом: материнський і батьківський.
        </p>
        <p>
