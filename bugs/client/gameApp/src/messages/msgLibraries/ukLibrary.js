...
const UK_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_START]: `
        ...
        <p> 
            Як тільки гніздо збудоване, це час для відкладання яєць. Зробити це можна в меню керування гніздом, яке відкриється по кліку на гніздо. 3-4 робочі мурахи для початку буде достатньо.
        <p/>
    `,
