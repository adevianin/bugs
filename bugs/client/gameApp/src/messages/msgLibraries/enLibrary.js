...
const EN_LIBRARY = {
    ...
    [GAME_MESSAGE_IDS.BREEDING_LABEL_NEW_COLONY_NAME]: 'Nest name:',
    ...
    [GAME_MESSAGE_IDS.QUEEN_SELECTOR_LABEL_BORN_ANTARA]: 'Give Birth to Antara Female',
    ...
    [GAME_MESSAGE_IDS.GENE_LABEL_SPECIALIZATION_BUILDING_SUBNEST_DESCRIPTION]: 'allows building multiple nests per colony',
    [GAME_MESSAGE_IDS.GENE_LABEL_ADAPTATION_APPETITE]: 'appetite gene',
    [GAME_MESSAGE_IDS.GENE_LABEL_ADAPTATION_APPETITE_DESCRIPTION]: 'determines the appetite of an adult ant',
    [GAME_MESSAGE_IDS.GENE_LABEL_ADAPTATION_DEVELOPMENT_APPETITE]: 'development appetite gene',
    [GAME_MESSAGE_IDS.GENE_LABEL_ADAPTATION_DEVELOPMENT_APPETITE_DESCRIPTION]: 'determines the food required for ant development',
    ...
    [GAME_MESSAGE_IDS.COLONIES_TAB_LABEL_COLONY_SELECTOR]: 'Queen:',
    ...
    [GAME_MESSAGE_IDS.ANTS_LIST_COL_NAME_TYPE]: 'caste',
    ...
    [GAME_MESSAGE_IDS.OPERATIONS_LIST_COL_LABEL_HIRING]: 'involved ants',
    ...
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_NEW_SUB_NEST_BTN_LABEL]: 'build satellite nest',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_DESTROY_NEST_BTN_LABEL]: 'destroy nest',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_PILLAGE_NEST_BTN_LABEL]: 'pillage nest',
    ...
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_BRING_BUG_CORPSE_BTN_LABEL]: 'bring the bug',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_CANCEL_OPERATION_CREATING_BTN_LABEL]: 'back',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_OPER_CATEGORY_TITLE_BUILDING]: 'construction',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_OPER_CATEGORY_TITLE_OFFENSIVE]: 'offensive',
    [GAME_MESSAGE_IDS.OPERATIONS_CREATOR_OPER_CATEGORY_TITLE_RESOURCE]: 'resource',
    ...
    [GAME_MESSAGE_IDS.NEST_MANAGER_MAIN_TAB_NEEDED_FOOD_COUNT_LABEL]: 'winter food reserves:',
    [GAME_MESSAGE_IDS.NEST_MANAGER_MAIN_TAB_NEST_POPULATION_LABEL]: 'nest population:',
    ...
    [GAME_MESSAGE_IDS.NEST_MANAGER_EGG_TAB_COL_TITLE_STATE]: 'progress',
    ...
    [GAME_MESSAGE_IDS.NEST_MANAGER_LARVA_TAB_DIED_LABEL]: 'died',
    ...
    [GAME_MESSAGE_IDS.ENEMIES_TAB_TABLE_COL_COLONY_NAME]: 'enemy queen’s name',
    ...
    [GAME_MESSAGE_IDS.NOTIFICATIONS_TAB_NO_NOTIFICATIONS_LABEL]: 'No notifications yet',
    [GAME_MESSAGE_IDS.NOTIFICATION_OBJECT_ANT]: 'Ant',
    [GAME_MESSAGE_IDS.NOTIFICATION_OBJECT_NEST]: 'Nest',
    [GAME_MESSAGE_IDS.NOTIFICATION_OBJECT_COLONY]: 'Colony of queen',
    ...
    [GAME_MESSAGE_IDS.NOTIFICATION_ANT_DEATH_NUPTIAL_FLIGHT]: 'left offspring and perished in the nuptial flight',
    ...
    [GAME_MESSAGE_IDS.MAP_PICKER_POSITION_TITLE]: 'choose location',
    ...
    [GAME_MESSAGE_IDS.HELP_TAB_SECTION_CONTENT_SPECIE]: `
        ...
        <p>
            To transfer new genes into your species, send males on a nuptial flight. They will find a distant female of your species and fertilize her. As a result, some of the male's genes will be passed on to the species and appear on the list of candidate genes. Choose males with the best genes, send them into flight — and gradually consolidate the good genes in your species.
        </p>
