...
const COMMON_UK_LIBRARY = {
    [COMMON_MESSAGE_IDS.USERNAME_MIN_LENGTH_ERR]: 'Мінімальна довжина — {0}.',
    [COMMON_MESSAGE_IDS.USERNAME_MAX_LENGTH_ERR]: 'Максимальна довжина — {0}.',
    [COMMON_MESSAGE_IDS.USERNAME_INVALID_CHARS]: 'Містить недопустимі символи.',
    ...
    [COMMON_MESSAGE_IDS.PASSWORD_MIN_LENGTH_ERR]: 'Мінімальна довжина — {0}.',
    [COMMON_MESSAGE_IDS.PASSWORD_MAX_LENGTH_ERR]: 'ПМаксимальна довжина — {0}.',
