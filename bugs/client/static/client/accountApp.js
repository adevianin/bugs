...
class AccountApi {
    ...
    login(username, password) {
        return this._requester.post('accounts/login', {
            username, password
        }).then((response) => {
    ...
    register(username, password) {
        return this._requester.post('accounts/register', {
            username, password
        }).then((response) => {
            return response.data.user;
        });
    ...
    checkUsernameUnique(username) {
        return this._requester.post('accounts/check_name', {
            username
        }).then((res) => {
...
}`, "",{"version":3,"sources":["webpack://./common/styles.css"],"names":[],"mappings":"AAAA;IACI;AACJ","sourcesContent":[".hidden {\r\n    display: none !important\r\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
