...
def fly_nuptial_flight(request: HttpRequest, ant_id: int):
    ...
    ef.fly_nuptial_flight_command(request.user.id, ant_id)
...
def change_ant_guardian_behavior(request: HttpRequest, ant_id: int):
    ...
    ef.change_ant_guardian_behavior_command(request.user.id, ant_id, guaridan_behavior)
...
def change_ant_cooperative_behavior(request: HttpRequest, ant_id: int):
    ...
    ef.change_ant_cooperative_behavior_command(request.user.id, ant_id, is_enabled)
...
def relocate_ant(request: HttpRequest, ant_id: int):
    ...
    ef.relocate_ant_command(request.user.id, ant_id, nest_id)
